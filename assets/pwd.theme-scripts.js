...
var dermFeatureInit = function dermFeatureInit() {
  window.addEventListener("load", function () {
    console.log('test dermFeatureInit');
    if (!window.customElements.get('slider-df')) {
      var SliderDermFeature = /*#__PURE__*/function (_HTMLElement) {
        function SliderDermFeature() {
          _classCallCheck(this, SliderDermFeature);
          return _callSuper(this, SliderDermFeature);
        }
        _inherits(SliderDermFeature, _HTMLElement);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (dermFeatureInit);
